...
public class D6_MadLibs {
    ...
    public void enterAdjective2() {
        System.out.println("I really need an alpaca... JK, give me another adjective");
    ...
    public void putTogetherTheStory() {
        ...
        if (num == 0) {
            ...
            story = "Amanda and her frenemy " + getName() + " went to the zoo last summer.\n"
                    ...
                    + " to get a closer look.\n" + "The zoo was " + getAdjective1()
                    + "at night, but they didn't care... until " + getRandomNums() + " " + getAdjective2()
                    + " apes yelled in their faces,\nmaking Amanda and " + getName() + " sprint all the way back home.";
            setStory(story);
        }
    ...
    public static void main(String[] args) {
        ...
        D6_MadLibs game = new D6_MadLibs();
